...
const navItems = [
  { href: getHospitalAdminPath(), label: 'Dashboard', icon: LayoutDashboard },
  { href: getHospitalAdminPath('/patients'), label: 'Patients', icon: UserRound },
  { href: getHospitalAdminPath('/doctors'), label: 'Doctors', icon: Stethoscope },
  { href: getHospitalAdminPath('/departments'), label: 'Departments', icon: Building2 },
  { href: getHospitalAdminPath('/staff'), label: 'Staff', icon: Users },
  { href: getHospitalAdminPath('/appointments'), label: 'Appointments', icon: CalendarDays },
  { href: getHospitalAdminPath('/admissions'), label: 'Admissions', icon: Bed },
  { href: getHospitalAdminPath('/settings'), label: 'Settings', icon: Settings },
];
...
export function HospitalAdminSidebar() {
  ...
  const handleRefreshData = async () => {
    try {
      ...
      await refreshHospitalAdminCache();
      toast.success('Hospital admin data updated locally.');
      setLastUpdated(getLatestHospitalAdminCacheUpdate());
    } catch {
      toast.error('Failed to update hospital admin data.');
    } finally {
